defmodule Covid19.DataTest do
  ...
  describe "states" do
    ...
    @update_attrs %{cases: 43, date: ~D[2011-05-18], deaths: 43, fips: 43, state: "some updated state"}
  ...
  describe "counties" do
    ...
    @valid_attrs %{cases: 42, county: "some county", date: ~D[2010-04-17], deaths: 42, fips: 42, state: "some state"}
    @update_attrs %{cases: 43, county: "some updated county", date: ~D[2011-05-18], deaths: 43, fips: 43, state: "some updated state"}
